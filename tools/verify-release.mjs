...
// Checks: TWO-ASSET RULE (assets named exactly module.json + rippers-stylish-hud.zip — a missing/mis-named
...
const REPO = 'RoscoeRackham/rippers-stylish-hud';
const ID = 'rippers-stylish-hud';
